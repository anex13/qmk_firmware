...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    [LAYER_ALPHA] = { ENCODER_CCW_CW(KC_WH_L, KC_WH_R), ENCODER_CCW_CW(KC_WH_D, KC_WH_U)  },
    [LAYER_NAV] = { ENCODER_CCW_CW(LCTL(KC_LEFT), LCTL(KC_RIGHT)),           ENCODER_CCW_CW(KC_DOWN, KC_UP)  },
